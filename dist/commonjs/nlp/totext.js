...
class ToText {
    ...
    bymonthday;
    byweekday;
    constructor(rrule, gettext = defaultGetText, language = i18n_js_1.default, dateFormatter = defaultDateFormatter) {
        this.text = [];
        this.language = language || i18n_js_1.default;
        ...
        if ((0, helpers_js_1.isPresent)(this.origOptions.byweekday)) {
            const byweekday = !(0, helpers_js_1.isArray)(this.origOptions.byweekday)
    ...
    toString() {
        ...
        // @ts-ignore
        this[rrule_js_1.RRule.FREQUENCIES[this.options.freq]]();
    ...
    weekdaytext(wday) {
        const weekday = (0, helpers_js_1.isNumber)(wday) ? (wday + 1) % 7 : wday.getJsWeekday();
